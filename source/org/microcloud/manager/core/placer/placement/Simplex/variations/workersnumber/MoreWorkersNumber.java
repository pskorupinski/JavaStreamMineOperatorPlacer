...
public class MoreWorkersNumber extends VariationImplCore implements WorkersNumber {

	public MoreWorkersNumber(PlacementProblem placementProblem) {
	...
	public Map<SolutionDestination<MicroCloud>, Integer> count(SolutionGraphFullMC fullInitGraph) {
		...
		workersNumberInSystem = (int) Math.round(1.25*(double)(workersNumberInSystem));
