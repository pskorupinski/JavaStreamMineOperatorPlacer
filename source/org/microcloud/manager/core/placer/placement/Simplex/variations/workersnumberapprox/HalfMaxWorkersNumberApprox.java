...
public class HalfMaxWorkersNumberApprox extends VariationImplCore implements WorkersNumberApprox {

	public HalfMaxWorkersNumberApprox(PlacementProblem placementProblem) {
	...
	public int count() {
		...
		return (int) Math.round((double)approximateWorkersNumber/2.0);
	}
