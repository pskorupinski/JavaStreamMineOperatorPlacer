...
public class MaxWorkersNumberApprox extends VariationImplCore implements WorkersNumberApprox {

	public MaxWorkersNumberApprox(PlacementProblem placementProblem) {
	...
	public int count() {
		...
		return approximateWorkersNumber;
	}
