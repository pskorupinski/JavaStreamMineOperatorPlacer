...
public class TestWorkersNumber extends VariationImplCore implements WorkersNumber {

	public TestWorkersNumber(PlacementProblem placementProblem) {
	...
	public Map<SolutionDestination<MicroCloud>, Integer> count(SolutionGraphFullMC fullInitGraph) {
		...
		int workersNumberInSystem = NextNumber.getNext();
