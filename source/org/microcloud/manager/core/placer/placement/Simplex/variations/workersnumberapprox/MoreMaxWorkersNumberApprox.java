...
public class MoreMaxWorkersNumberApprox extends VariationImplCore implements WorkersNumberApprox {

	public MoreMaxWorkersNumberApprox(PlacementProblem placementProblem) {
	...
	public int count() {
		...
		return (int) (1.5*approximateWorkersNumber);
	}
